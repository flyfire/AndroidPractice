...
class NestedScrollingParentL @JvmOverloads constructor(
    ...
    override fun onStartNestedScroll(child: View, target: View, nestedScrollAxes: Int): Boolean {
        Log.d(
            TAG,
            "onStartNestedScroll() called with: child = $child, target = $target, nestedScrollAxes = $nestedScrollAxes"
        )
        return true
    }
    ...
    override fun onNestedScrollAccepted(child: View, target: View, axes: Int) {
        Log.d(
            TAG,
            "onNestedScrollAccepted() called with: child = $child, target = $target, axes = $axes"
        )
    ...
    override fun onNestedScroll(
        ...
        Log.d(
            TAG,
            "onNestedScroll() called with: target = $target, dxConsumed = $dxConsumed, dyConsumed = $dyConsumed, dxUnconsumed = $dxUnconsumed, dyUnconsumed = $dyUnconsumed"
        )
    }
    ...
    override fun onNestedPreScroll(target: View, dx: Int, dy: Int, consumed: IntArray) {
        ...
        Log.d(
            TAG,
            "onNestedPreScroll() called with: target = $target, dx = $dx, dy = $dy, consumed = $consumed, scrollY = $scrollY"
        )
    }
    ...
    override fun onNestedFling(
        ...
        Log.d(
            TAG,
            "onNestedFling() called with: target = $target, velocityX = $velocityX, velocityY = $velocityY, consumed = $consumed"
        )
        return true
    }
    ...
    override fun onNestedPreFling(target: View, velocityX: Float, velocityY: Float): Boolean {
        Log.d(
            TAG,
            "onNestedPreFling() called with: target = $target, velocityX = $velocityX, velocityY = $velocityY"
        )
        return true
    }
